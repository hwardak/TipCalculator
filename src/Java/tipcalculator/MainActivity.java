...
public class MainActivity extends ActionBarActivity implements MainFragment.onUpdate, ViewRecordFragment.OnTiptSelectedListener, ViewDetailsRecordFragment.OnTipsDetailListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        summaryButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(MainActivity.this, SummaryView.class);
    ...
    /**
     * This method is invoked when the 'Help' view is clicked, it simply swaps in a new fragment
     * with a textview that explains how the app is to work.
     * @param view the help buttoni.
     */
